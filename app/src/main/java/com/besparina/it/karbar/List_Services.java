    ...
    public class List_Services extends Activity {
        ...
        catch (Exception e)
        {
            ...
            Cursor coursors = db.rawQuery("SELECT BsUserServices.*,Servicesdetails.name FROM BsUserServices " +
                    ...
                    "Order by BsUserServices.Code desc",null);
            for(int i=0;i<coursors.getCount();i++){
                coursors.moveToNext();
            ...
            btnServiceEmergency.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (ActivityCompat.checkSelfPermission(List_Services.this,
                            android.Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED) {
                        if(ActivityCompat.shouldShowRequestPermissionRationale(List_Services.this, android.Manifest.permission.CALL_PHONE))
                        {
                            ActivityCompat.requestPermissions(List_Services.this,new String[]{android.Manifest.permission.CALL_PHONE},2);
                        }
                        else
                        {
                            ActivityCompat.requestPermissions(List_Services.this,new String[]{android.Manifest.permission.CALL_PHONE},2);
