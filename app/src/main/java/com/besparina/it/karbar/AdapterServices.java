...
//        }
        ...
        {
            holder.LinearTitle.setBackgroundColor(Color.RED);
        }
        else
        {
            holder.LinearTitle.setBackgroundColor(Color.GREEN);
        }
        return convertView;
    }
