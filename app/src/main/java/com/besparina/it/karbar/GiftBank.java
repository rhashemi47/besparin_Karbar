...
//            db.close();
            ...
            btnServiceEmergency.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (ActivityCompat.checkSelfPermission(GiftBank.this,
                            android.Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED) {
                        if(ActivityCompat.shouldShowRequestPermissionRationale(GiftBank.this, android.Manifest.permission.CALL_PHONE))
                        {
                            ActivityCompat.requestPermissions(GiftBank.this,new String[]{android.Manifest.permission.CALL_PHONE},2);
                        }
                        else
                        {
                            ActivityCompat.requestPermissions(GiftBank.this,new String[]{android.Manifest.permission.CALL_PHONE},2);
