            ...
            btnServiceEmergency.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (ActivityCompat.checkSelfPermission(Help.this,
                        ...
                        if(ActivityCompat.shouldShowRequestPermissionRationale(Help.this, android.Manifest.permission.CALL_PHONE))
                        {
                            ActivityCompat.requestPermissions(Help.this,new String[]{android.Manifest.permission.CALL_PHONE},2);
                        }
                        else
                        {
                            ActivityCompat.requestPermissions(Help.this,new String[]{android.Manifest.permission.CALL_PHONE},2);
