...
public class SyncGetBsUserServiceQuestion {
	...
	//Contractor
	public SyncGetBsUserServiceQuestion(Activity activity,String BsUserServiceCode) {
	...
	private class AsyncCallWS extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
        	...
        	try
        	{
        		CallWsMethod("GetBsUserServiceQuestion");
        	}
	    	catch (Exception e) {
